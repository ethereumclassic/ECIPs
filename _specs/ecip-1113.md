...
This ECIP defines the on-chain governance framework for **Olympia DAO**, the *sole authorized executor* of disbursements from the immutable **Olympia Treasury** (ECIP-1112) funded by `BASEFEE` revenue redirected under ECIP-1111.  
...
This ECIP specifies the architecture of **Olympia DAO** — the decentralized governance system that serves as the *sole authorized executor* for releasing funds from the immutable **Olympia Treasury** (ECIP-1112), which accumulates `BASEFEE` revenue redirected at the consensus layer under ECIP-1111.  
...
- **Treasury Access Control**  
  - The DAO’s executor SHALL be the *sole authorized caller* of the Treasury’s disbursement functions.
...
- Once the DAO’s executor address is set in the Treasury contract, it becomes the **sole authorized caller** of the Treasury’s disbursement functions.
