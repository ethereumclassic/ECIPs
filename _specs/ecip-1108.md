...
Pages must be named after the full ECIP number (eg, "ECIP 1108") and placed in the "Comments" namespace.

For example, the link for ECIP 1 will be:

	https://github.com/ethereumclassic/ECIPs/wiki/Comments:ECIP-1108 .
