...
lang: en
ecip: 1120
title: WIP Basefee Market with Miner Rewards
subtitle: An implementation of EIP-1559 for Ethereum Classic
...
| Distribution curve | Uniform* | Shape of fee distribution (uniform or decay) |
...
The backward fees block count and distribution curve shape balance client performance (fewer calculations per block) against sufficient smoothing to achieve the desired incentive properties. Final values require implementation and testing across ETC clients to determine optimal tradeoffs.
