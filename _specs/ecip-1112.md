...
Other EVM-based networks have adopted similar protocol-level fee redirection models to fund public goods. These implementations demonstrate that **routing BASEFEE or sequencer revenue into a DAO-governed treasury** is a proven, scalable strategy for sustaining decentralized ecosystems:

- **Ronin Network**  
  Routes EIP-1559 `BASEFEE` to a DAO-controlled treasury supporting Axie Infinity infrastructure.

- **Celo (Layer 1)**  
  Redirects gas fees to a Gas Fee Handler for climate initiatives and community funding.

- **Mantle (Layer 2)**  
  Uses sequencer revenue redirection to support ecosystem grants via MantleDAO.

- **Polygon CDK (Modular Rollup Framework)**  
  Integrates EIP-1559-compatible treasury redirection for sovereign rollups, enabling rollup creators to govern and fund upgrades.

- **OP Stack (used by Base, Optimism)**  
  Supports sequencer revenue sharing with governance control; while not always redirecting `BASEFEE`, it enables fee-split mechanisms for public goods funding.

- **Arbitrum (Layer 2)**  
  Routes sequencer revenue to a DAO-managed treasury, with disbursements governed by the Arbitrum Improvement Proposal (AIP) process.

- **Optimism (Layer 2)**  
  Allocates sequencer revenue to Retroactive Public Goods Funding (RPGF), rewarding impactful ecosystem contributions.

- **zkSync Era & Scroll (Layer 2)**  
  Incorporate sequencer revenue hooks to fund development incentives and ecosystem growth.

- **Avalanche Subnets**  
  Some subnets implement fee-to-treasury mechanisms governed by subnet validators, directing network revenue toward maintenance and growth.

These precedents validate the neutrality, feasibility, and long-term sustainability of protocol-native treasury funding. Redirecting endogenous protocol revenue to transparent, on-chain treasuries aligns economic incentives between users, operators, and developers — while eliminating reliance on inflationary subsidies or centralized donors.
...
- **Celo (Layer 1)**  
  ...
  [View Governance and Treasury Contracts](https://celoscan.io/address/0xd533ca259b330c7a88f74e000a3faea2d63b7972#code)
...
- **OP Stack (used by Base, Optimism)**  
  Supports EIP-1559-style transactions and sequencer revenue splitting, enabling fee-share models for public goods funding. While not always redirecting `BASEFEE`, it establishes governance patterns applicable to treasury design.

- **Arbitrum (Layer 2)**  
  Routes sequencer revenue into a DAO-managed treasury, with allocations decided through the Arbitrum Improvement Proposal (AIP) process.  
  [Learn More](https://docs.arbitrum.foundation/dao-governance)

- **Optimism (Layer 2)**  
  Uses sequencer revenue to fund Retroactive Public Goods Funding (RPGF) rounds, rewarding high-impact ecosystem contributions.  
  [RPGF Overview](https://community.optimism.io/docs/governance/)

- **zkSync Era & Scroll (Layer 2)**  
  Integrate sequencer revenue hooks into protocol design to fund ecosystem growth, development incentives, and infrastructure.

- **Avalanche Subnets**  
  Some subnets implement validator-governed fee-to-treasury mechanisms, routing network revenue to community-controlled funds.

- **Gitcoin DAO**  
  Specializes in funding open-source software and digital public goods through quadratic funding and direct grants. While not funded via `BASEFEE` capture, it provides a widely recognized governance and distribution framework for transparent, community-driven grant allocation.  
  [Gitcoin DAO](https://gitcoin.co/)

These implementations reflect a broader trend: **redirecting protocol revenue to transparent, on-chain treasuries is an effective, neutral, and incentive-aligned strategy** for funding ecosystem development without introducing inflation or centralized control. The diversity of approaches — from BASEFEE capture to sequencer fee allocation — demonstrates both the flexibility and the sustainability of this model across different network architectures.

#### Addendum: Verified Contract References

For deeper implementation study and validation, below are verified contracts and governance documentation used by other EVM ecosystems:
...
- **Mantle Fee Mechanism**  
  [Mantle Docs](https://docs.mantle.xyz/network/system-information/fee-mechanism)

- **Polygon CDK (Modular Rollup Framework)**  
  [Polygon CDK Overview](https://docs.polygon.technology/)

- **OP Stack (Base / Optimism) Sequencer Revenue Sharing**  
  [Optimism Docs](https://community.optimism.io/docs/governance/) — Governance and treasury design reference.

- **Arbitrum DAO Treasury Governance**  
  [Arbitrum Foundation DAO Governance](https://docs.arbitrum.foundation/dao-governance)

- **Optimism Retroactive Public Goods Funding (RPGF)**  
  [RPGF Overview](https://community.optimism.io/docs/governance/)

- **Gitcoin DAO Grants & Quadratic Funding**  
  [Gitcoin DAO](https://gitcoin.co/) — Treasury-funded public goods distribution system.

- **Avalanche Subnet Validator-Governed Treasury Examples**  
  [Avalanche Subnet Docs](https://docs.avax.network/subnets) — Fee-to-treasury implementations.

- **zkSync Era & Scroll Sequencer Revenue Hooks**  
  [zkSync Docs](https://era.zksync.io/docs/) | [Scroll Docs](https://docs.scroll.io/) — Protocol-integrated funding flows.

These implementations support the validity, neutrality, and resilience of redirecting protocol-layer fees to transparent, on-chain treasuries, and provide governance and distribution models applicable to Ethereum Classic’s Olympia Treasury design.
