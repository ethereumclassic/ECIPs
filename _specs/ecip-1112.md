...
The address derivation MUST use a deterministic method (e.g., `CREATE2`) and be reproducible across all client implementations. The final address SHALL be published in coordination with Core-Geth.
...
- **Ronin Treasury Contract**  
  [`0x9f76...5217`](https://explorer.roninchain.com/address/0x9f76b782bdfba7a5e9eaa9b7b0f2c78b6596b217)

- **Celo Gas Fee Handler**  
  [`0x471E...8438`](https://explorer.celo.org/address/0x471EcE3750Da237f93B8E339c536989b8978a438)

- **Mantle Treasury Flow (Docs)**  
  [https://docs.mantle.xyz/network/mantle-tokenomics/treasury-flow](https://docs.mantle.xyz/network/mantle-tokenomics/treasury-flow)

- **Polygon CDK Modular Treasury (Overview)**  
  [https://polygon.technology/blog/polygon-cdk-announces-native-support-for-eip-4844-and-modular-daos](https://polygon.technology/blog/polygon-cdk-announces-native-support-for-eip-4844-and-modular-daos)
