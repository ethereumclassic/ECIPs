...
interface IDAOExecutor {
    function isApprovedProposal(bytes32 proposalHash) external view returns (bool);
}
...
contract OlympiaTreasury {
    ...
    event FundsReleased(bytes32 indexed proposalHash, address recipient, uint256 amount);
    ...
    function release(bytes32 proposalHash, address payable recipient, uint256 amount) external {
