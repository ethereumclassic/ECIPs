...
The Olympia upgrade introduces a new transaction type and an additional EVM opcode. Legacy transactions and deployed contracts will continue to function without modification. However, nodes that do not upgrade will fall out of consensus once the fork is activated.
