...
- This is illustrative only — the real implementation resides in:
  - [`miner/block.go`](https://github.com/ethereumclassic/core-geth/tree/master/miner)
  - [`core/state_transition.go`](https://github.com/ethereumclassic/core-geth/blob/master/core/state_transition.go)
...
ECIP-1111 introduces the redirection of `BASEFEE` revenue to an on-chain treasury but does **not** require immediate activation of downstream governance components — including [ECIP-1113](https://ecips.ethereumclassic.org/ECIPs/ecip-1113) (Olympia DAO) or [ECIP-1114](https://ecips.ethereumclassic.org/ECIPs/ecip-1114) (Ethereum Classic Funding Proposal Process).
