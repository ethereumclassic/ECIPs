...
> This version (v2) of the Ethereum Classic forkid specification corrects Kotti
> forkid expectations. The derivation removes wrongly configured Ethash specifications
> for the chain configuration, and in doing so removes two invalid forks from
> the parameterized fork list.
