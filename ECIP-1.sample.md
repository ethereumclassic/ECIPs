...
### Implementation
Fork the [ECIP repo](https://github.com/ethereumproject/EIPs). Write an ECIP using the [ECIP markdown template](./ECIP-0000.md.template) and initiate a pull request.
