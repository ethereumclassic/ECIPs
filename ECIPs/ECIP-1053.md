...
The OpenRPC Document that implements all the methods from [EIP #1474](https://github.com/ethereum/EIPs/pull/1474) and [EIP #1436](https://github.com/ethereum/EIPs/pull/1436) and `getRawTransaction*` can be found in [assets/ecip-1053/openrpc.json](assets/ecip-1053/openrpc.json).
